...
proc create_root_design { parentCell } {
  ...
  set dac_masked_GPIO [ create_bd_port -dir O -from 13 -to 0 dac_masked_GPIO ]
  ...
  connect_bd_net -net PNR_main_0_dac_masked_GPIO [get_bd_ports dac_masked_GPIO] [get_bd_pins PNR_main_0/dac_masked_GPIO]
  ...
  connect_bd_net -net PNR_register_0_dac_logic_mask [get_bd_pins PNR_main_0/dac_logic_mask] [get_bd_pins PNR_register_0/dac_logic_mask]
