...
if { ${design_name} eq "" } {
  ...
  set_property USER_COMMENTS.comment_2 "インターコネクトはかつて判別したい光子数だけAXI GPIOを生やしていたときの残骸。なにか急にGPIOが欲しくなったときのために残しておる。" [get_bd_designs $design_name]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net processing_system7_0_fclk_clk0 [get_bd_ports FCLK_CLK0] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins processing_system7/FCLK_CLK0] [get_bd_pins rst_ps7_125M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_125M_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins rst_ps7_125M/peripheral_aresetn]
